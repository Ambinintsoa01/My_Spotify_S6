  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, width: 260, flexShrink: 0 }}>
        <div style={{
          width: 44, height: 44, borderRadius: "var(--radius-sm)", background: "linear-gradient(135deg,var(--violet),#A78BFA44)",
          display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0
        }}>
          <WaveformBars isPlaying={isPlaying} />
        </div>
        {/* Rendu des informations de la piste dans ton MiniPlayer.jsx */}
        <div style={{ display: "flex", flexDirection: "column" }}>
          <span style={{ fontSize: 13, fontWeight: 600, color: "var(--text-primary)" }}>
            {current ? current.title : "Aucune chanson en lecture"}
          </span>
          <span style={{ fontSize: 11, color: "var(--text-muted)" }}>
            {current ? current.artist : "Artiste inconnu"}
          </span>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <button onClick={togglePlay}
            style={{
              width: 40, height: 40, borderRadius: "50%", background: "var(--violet)", border: "none", cursor: "pointer",
